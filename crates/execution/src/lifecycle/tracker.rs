...
impl LifecycleTracker {
    ...
    pub async fn record_fee_checkpoint(&self, checkpoint: PositionFeeCheckpoint) {
        let row = serde_json::json!({
            ...
            "tick_current": checkpoint.tick_current,
            "liquidity": checkpoint.liquidity,
            "fees_owed_a": checkpoint.fees_owed_a,
            "fees_owed_b": checkpoint.fees_owed_b,
            "fee_growth_checkpoint_a": checkpoint.fee_growth_checkpoint_a,
            "fee_growth_checkpoint_b": checkpoint.fee_growth_checkpoint_b,
            "fee_growth_global_a": checkpoint.fee_growth_global_a,
            "fee_growth_global_b": checkpoint.fee_growth_global_b,
            "fee_growth_outside_lower_a": checkpoint.fee_growth_outside_lower_a,
            "fee_growth_outside_lower_b": checkpoint.fee_growth_outside_lower_b,
            "fee_growth_outside_upper_a": checkpoint.fee_growth_outside_upper_a,
            "fee_growth_outside_upper_b": checkpoint.fee_growth_outside_upper_b,
            "fee_growth_inside_a": checkpoint.fee_growth_inside_a,
            "fee_growth_inside_b": checkpoint.fee_growth_inside_b,
            "sqrt_price_x64": checkpoint.sqrt_price_x64,
