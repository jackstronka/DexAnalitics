...
use crate::handlers;
use crate::models::{
    ActiveSignerResponse, AgentChatMessage, AgentChatResponse, AgentChatUiPayload,
    ...
    ApiSignerWalletResponse, BacktestDataReadinessAggregate, BacktestDataReadinessRequest,
    ...
    BacktestJobStatusResponse, BotActivityJsonlResponse, BotRegistryJsonlResponse,
    BuildUnsignedTxRequest, BuildUnsignedTxResponse, CloseAllBatchItem, CloseAllBatchStatusResponse,
    CloseAllBatchSummary, CloseAllItemStatus, CloseAllPositionsOptions, CloseAllPositionsRequest,
    CloseAllPositionsStartResponse, CloseAllSkippedPreview, CloseAllWalletGroup,
    CloseAllPositionsPreviewResponse,
    ClosedPositionEntry, ClosedPositionsResponse,
    ConvertSolDirection, ConvertSolRequest, ConvertSolResponse, CreateStrategyRequest,
    CreateWalletRequest, CreateWalletResponse, DecreaseLiquidityRequest, EventBusMetricsResponse,
    HealthResponse, JupiterPricesResponse, LineageChainCostSummary, LinkPositionStrategyRequest,
    ListPoolsResponse, ListPositionsResponse, ListStrategiesResponse, MarketDataQuery,
    MarketSnapshotRow, MarketSnapshotsResponse, MarketSwapRow, MarketSwapsResponse,
    MaterializeChainHistoryResponse, MessageResponse, MetricsResponse, OpenPositionRequest,
    OrcaLockResponse, OrcaOwnerPositionEntry, OrcaOwnerPositionsResponse, OrcaProtocolResponse,
    OrcaTokenListResponse, OrcaTokenResponse, PhantomChallengeRequest, PhantomChallengeResponse,
    PhantomSessionResponse, PhantomVerifyRequest, PnLResponse, PoolResponse, PoolStateResponse,
    PortfolioAnalyticsResponse, PositionDiagnosticsResponse, PositionExperimentConfigResponse,
    PositionListExtrasEntry, PositionsListExtrasRequest, PositionsListExtrasResponse,
    PositionLastEvalSnapshot, PositionLifecycleEvent, PositionLifecycleSessionSummary,
    PositionLifecycleSummaryResponse, PositionOpenResponse, PositionResponse,
    PositionStrategyDiagnostics, PositionStreamLineageNode, PositionStreamLineageResponse,
    PositionStreamPerformanceResponse, PositionStreamPnLResponse, QuoteOpenBudgetRequest,
    QuoteOpenBudgetResponse, RebalanceRequest, RunScriptRequest, ScriptCatalogItem,
    ScriptRunRecord, ScriptsListResponse, SetActiveSignerRequest, SimulationRequest,
    SimulationResponse, SlackActivitySummaryRequest, SlackActivitySummaryResponse,
    SlipstreamSlot0Response, StrandedRebalanceItem, StrandedRebalancesResponse,
    ...
    SwapCostEstimateResponse, SwapInPoolBeforeOpen, UncollectedFeesInfo, WalletBalanceConfidence,
    WalletBalancesResponse, WalletConvertOpResponse, WalletEffectiveBalancesResponse, WalletEntry,
    WalletLedgerDelta, WalletLedgerEvent, WalletLedgerEventsResponse, WalletLedgerStatus,
    WalletSessionBalanceRow, WalletSessionBalancesResponse, WalletSessionGlBackfillReport,
    WalletSessionMetrics, WalletSessionOpenStartSnapshot,
    WalletSessionGlReconcileGap, WalletSessionGlReconcileResponse,
    WalletOpsStatsResponse, WalletReconcileItem, WalletReconcileResponse,
    ...
    WalletTransfersListResponse, WalletWsMetricsResponse, WalletWsStatusResponse,
    WalletsListResponse,
};
use utoipa::OpenApi;
...
#[openapi(
    ...
    paths(
        ...
        handlers::post_close_all_positions,
        handlers::post_close_all_positions_preview,
        handlers::get_close_all_positions_batch,
        handlers::collect_fees,
        handlers::decrease_liquidity,
        handlers::rebalance_position,
        handlers::get_position_pnl,
        handlers::post_positions_list_extras,
        ...
        handlers::get_position_chain_history,
        handlers::refresh_position_chain_history,
        ...
        handlers::get_backtest_data_readiness,
        ...
        handlers::get_wallet_effective_balances,
        handlers::get_wallet_ws_status,
        handlers::get_api_signer_wallet,
        handlers::get_active_signer,
        handlers::set_active_signer,
        handlers::convert_sol,
        handlers::list_wallet_ops,
        handlers::get_wallet_op,
        handlers::get_wallet_ops_stats,
        handlers::transfer_sol_between_wallets,
        handlers::list_wallet_transfers,
        handlers::get_wallet_ledger_events,
        handlers::get_wallet_session_balances,
        handlers::post_wallet_session_balances_backfill,
        handlers::post_wallet_reconcile_session_gl,
    ...
    components(
        schemas(
            ...
            CloseAllPositionsPreviewResponse,
            CloseAllWalletGroup,
            CloseAllSkippedPreview,
            CloseAllBatchStatusResponse,
            CloseAllBatchSummary,
            CloseAllBatchItem,
            CloseAllItemStatus,
            ...
            PositionsListExtrasRequest,
            PositionsListExtrasResponse,
            ...
            MaterializeChainHistoryResponse,
            OpenPositionRequest,
            ...
            BacktestDataReadinessRequest,
            BacktestDataReadinessRow,
            BacktestDataReadinessAggregate,
            BacktestDataReadinessThresholds,
            BacktestDataReadinessResponse,
            ...
            WalletWsStatusResponse,
            WalletBalanceConfidence,
            WalletWsMetricsResponse,
            WalletTokenBalance,
            CreateWalletRequest,
            ...
            WalletLedgerDelta,
            WalletLedgerEvent,
            WalletLedgerEventsResponse,
            WalletSessionBalanceRow,
            WalletSessionBalancesResponse,
            WalletSessionMetrics,
            WalletSessionOpenStartSnapshot,
            WalletSessionGlBackfillReport,
            WalletSessionGlReconcileGap,
            WalletSessionGlReconcileResponse,
            WalletReconcileItem,
